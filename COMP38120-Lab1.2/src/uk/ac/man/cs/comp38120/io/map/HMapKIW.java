...
import uk.ac.man.cs.comp38120.util.map.HMapKI;
import uk.ac.man.cs.comp38120.util.map.MapKI;
 ...
 * @author Jimmy Lin
 */
public class HMapKIW<K extends WritableComparable<?>> extends HMapKI<K>
        implements Writable
{
     ...
     * @throws IOException
     */
    public static <T extends WritableComparable<?>> HMapKIW<T> create(
