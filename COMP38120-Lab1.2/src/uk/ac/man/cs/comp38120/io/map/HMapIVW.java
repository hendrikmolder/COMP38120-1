...
import uk.ac.man.cs.comp38120.util.map.HMapIV;
import uk.ac.man.cs.comp38120.util.map.MapIV;

/**
 * Writable representing a map from ints to values of arbitrary
 * WritableComparable.
 * 
 * @param <V>
 *            type of value
 ...
 * @author Jimmy Lin
 */
public class HMapIVW<V extends WritableComparable<?>> extends HMapIV<V>
        implements Writable
{
     ...
     * @throws IOException
     */
    public static <T extends WritableComparable<?>> HMapIVW<T> create(
