...
public class HMapIF implements MapIF, Cloneable, Serializable
{
    ...
    /**
     * Constructs an empty <tt>HMapIF</tt> with the default initial capacity
    ...
    /**
     * Constructs a new <tt>HMapIF</tt> with the same mappings as the specified
     * <tt>MapIF</tt>. The <tt>HMapIF</tt> is created with default load factor
     * (0.75) and an initial capacity sufficient to hold the mappings in the
     * specified <tt>MapIF</tt>.
     * 
     * @param m
    ...
    {
        for (Iterator<? extends MapIF.Entry> i = m.entrySet().iterator(); i
                .hasNext();)
        {
    ...
    /**
     * Returns a shallow copy of this <tt>HMapIF</tt> instance: the keys and
    ...
    private final class EntryIterator extends HashIterator<MapIF.Entry>
    {
    ...
    private transient Set<MapIF.Entry> entrySet = null;
    ...
    /**
     * Save the state of the <tt>HMapIF</tt> instance to a stream (i.e.,
     * serialize it).
     * 
     * @serialData The <i>capacity</i> of the HMapIF (the length of the bucket
