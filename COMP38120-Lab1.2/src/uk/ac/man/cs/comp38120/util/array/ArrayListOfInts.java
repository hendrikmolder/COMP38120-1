...
package uk.ac.man.cs.comp38120.util.array;
        ...
        Iterable<Integer>
{
     ...
     * 
     * @param first
     *            the smallest int in the range (inclusive)
     * @param last
     *            the largest int in the range (exclusive)
     */
    ...
    /**
     * Returns a string representation of the object, explicitly printing out
     * the first <i>n</i> elements of this list.
     */
     ...
     * 
     * @param other
     *            other list to be intersected with this list
     ...
     * Duplicate items remain in the merged list.
     * 
     * @param sortedLst
     *            list to be merged into this
    ...
    /**
     * Merges two sorted (ascending order) lists into one sorted union.
     * Duplicate items are discarded in the merged list.
     * 
     * @param sortedLst
     *            list to be merged into this
     * @return merged sorted (ascending order) union of this and sortedLst
