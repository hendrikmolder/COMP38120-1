...
public interface MapII
{
     ...
     */
    Set<MapII.Entry> entrySet();

    /**
     * A map entry (key-value pair) for <tt>MapII</tt>. The
     * <tt>MapII.entrySet</tt> method returns a collection-view of the map,
     ...
     * These <tt>MapII.Entry</tt> objects are valid <i>only</i> for the duration
