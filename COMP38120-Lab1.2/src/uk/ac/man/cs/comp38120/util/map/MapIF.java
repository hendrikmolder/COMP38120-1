/*
 * @(#)Map.java 1.56 06/04/21 Copyright 2006 Sun Microsystems, Inc. All rights
...
public interface MapIF
{
    ...
    /**
     * Returns <tt>true</tt> if this map contains one or more mappings with the
     * specified value.
     * 
     * @param value
    ...
    /**
     * Returns a {@link Set} view of the keys contained in this map. Note that
     ...
     * Unlike a standard Java <tt>Map</tt>, values in the backing map cannot be
     * altered with this collection view.
     * 
     ...
     * the float values, which is exactly what this implementation is trying to
     ...
     */
    Set<MapIF.Entry> entrySet();

    /**
     * A map entry (key-value pair) for <tt>MapIF</tt>. The
     ...
     * These <tt>MapIF.Entry</tt> objects are valid <i>only</i> for the duration
