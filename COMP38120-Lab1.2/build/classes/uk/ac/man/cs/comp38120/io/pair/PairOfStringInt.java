...
/**
 * WritableComparable representing a pair consisting of a String and an int. The
 * elements in the pair are referred to as the left and right elements. The
    ...
    public static class Comparator extends WritableComparator
    {
        ...
        public int compare(byte[] b1, int s1, int l1, byte[] b2, int s2, int l2)
        {
            try
            {
                ...
                int cmp = compareBytes(b1, s1 + firstVIntL1, firstStrL1, b2, s2
                        + firstVIntL2, firstStrL2);
                if (cmp != 0)
                {
                    return cmp;
                }
