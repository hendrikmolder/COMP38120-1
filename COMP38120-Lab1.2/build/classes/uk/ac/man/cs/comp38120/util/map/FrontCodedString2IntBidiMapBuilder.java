...
public class FrontCodedString2IntBidiMapBuilder
{
    private static final Logger LOG = Logger
            .getLogger(FrontCodedString2IntBidiMapBuilder.class);
    ...
    public static void main(String[] args) throws Exception
    {
        ...
        if (!cmdline.hasOption(INPUT) || !cmdline.hasOption(OUTPUT))
        {
            ...
            formatter
                    .printHelp(
                            FrontCodedString2IntBidiMapBuilder.class.getName(),
                            options);
        ...
        FrontCodedStringList frontcodedList = new FrontCodedStringList(
                stringList, 8, true);
        ...
        ShiftAddXorSignedStringMap dict = new ShiftAddXorSignedStringMap(
                stringList.iterator(),
                new TwoStepsLcpMonotoneMinimalPerfectHashFunction<CharSequence>(
                        stringList, TransformationStrategies.prefixFreeUtf16()));
