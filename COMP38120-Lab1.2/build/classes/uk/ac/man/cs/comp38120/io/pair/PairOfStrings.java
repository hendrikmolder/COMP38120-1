    ...
    public static class Comparator extends WritableComparator
    {
        ...
        public int compare(byte[] b1, int s1, int l1, byte[] b2, int s2, int l2)
        {
            try
            {
                ...
                int secondVIntL1 = WritableUtils.decodeVIntSize(b1[s1
                        + firstVIntL1 + firstStrL1]);
                int secondVIntL2 = WritableUtils.decodeVIntSize(b2[s2
                        + firstVIntL2 + firstStrL2]);
                ...
                return compareBytes(b1, s1 + firstVIntL1 + firstStrL1
                        + secondVIntL1, secondStrL1, b2, s2 + firstVIntL2
